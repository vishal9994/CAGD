...
a2=sort(aa);         %Sorting the matrix
k=find(a2==xii);     %Finding psition of selected point in matrix
if rem(k,2)==0       %Checking if odd or even
    txt = [ 'INSIDE ']; %FOr Inside
    text(4,9,txt)
else
    txt = ['OUTSIDE'];  %FOr Outside
text(4,9,txt)
end
